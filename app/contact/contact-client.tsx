...
export default function ContactPageClient() {
  ...
  const faqItems: FAQItem[] = [
    {
      ...
      answer: "You can book directly through our website on the Booking page, send us an email at info@limozrwanda.com, or reach us instantly via WhatsApp at +250788318990.",
    },
    {
    ...
    },
    {
      ...
      answer: "We are available 7 days a week. For urgent bookings or last-minute requests, you can reach us via WhatsApp at +250788318990.",
    },
    {
  ...
  async function handleContactSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setSubmitStatus({
        type: "error",
        message: "Failed to send message. Please try again or contact us directly at +250788318990.",
      })
    } finally {
